...
PREDECL(CIFA_ID_F16, 'f', '1', '6')
PREDECL(CIFA_ID_F32, 'f', '3', '2')
PREDECL(CIFA_ID_F64, 'f', '6', '4')
PREDECL(CIFA_ID_COMPLEX, 'c', 'o', 'm', 'p', 'l', 'e', 'x')
PREDECL(CIFA_ID_C16, 'c', '1', '6')
PREDECL(CIFA_ID_C32, 'c', '3', '2')
PREDECL(CIFA_ID_C64, 'c', '6', '4')
PREDECL(CIFA_ID_BOOL, 'b', 'o', 'o', 'l')
PREDECL(CIFA_ID_CHAR, 'c', 'h', 'a', 'r')
